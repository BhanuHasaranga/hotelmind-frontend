...
export async function TopBar({ title, subtitle, dataSource }: TopBarProps) {
  ...
  // Fixed height matches the sidebar brand block (py-5 + 24px icon / two-line
  // text stack) so both bottom borders land on the same line, regardless of
  // whether this header renders a subtitle.
  return (
    <header className="flex h-19 items-center justify-between border-b border-border bg-card px-6">
